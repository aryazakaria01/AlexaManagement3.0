...
buttons = [
    ...
    [
        InlineKeyboardButton(text="💌 ᴏᴡɴᴇʀ", url="https://t.me/Dr_Assad_Ali"),
        InlineKeyboardButton(
            text="💌 ɴᴇᴛᴡᴏʀᴋ", url="https://t.me/Shayri_Music_Lovers"
        ),
    ],
    [
...
""".format(
    ...
    "📝All commands can either be used with / or !." if ALLOW_EXCL else "",
)
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module(
        f"RocksAlexaRobot.modules.{module_name}"
    )
        ...
        update.effective_message.reply_video(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="💌 ᴋɪɴɢ ", url="t.me/Dr_Assad_Ali"
                        ),
                        InlineKeyboardButton(
                            text="😎 ᴜᴘᴅᴀᴛᴇs ", url="t.me/AsadSupport"
                        ),
                    ]
                ]
            ),
